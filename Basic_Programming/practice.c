...
char * g_type_all[] = {"anxin", "antrom", "congnhan"};
...
int main()
{
    ...
    for (counter = 0; counter < number_people; counter++)
    {
        create_person(&people[counter], g_type_all[rand() % 3]);
    }
